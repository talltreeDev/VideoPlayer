...
export interface InterfaceSlice {
  interface: {
    ...
    error?: DisplayError;
    skipTimeList: number[];
    skipTimeShow: boolean;
    skipSettingShow: boolean;
  ...
  setAutoSkipTime(t: number[]): void;
  setAutoSkipShow(s: boolean): void;
  setAutoSkipValue(s: boolean): void;
}
...
export const createInterfaceSlice: MakeSlice<InterfaceSlice> = (set, get) => ({
  ...
  setAutoSkipTime(time: number[]) {
    set((s) => {
      s.interface.skipTimeList = time;
    });
  },
  setAutoSkipShow(show: boolean) {
    set((s) => {
      s.interface.skipTimeShow = show;
    });
  },
  setAutoSkipValue(show: boolean) {
    set((s) => {
      s.interface.skipSettingShow = show;
    });
  },
